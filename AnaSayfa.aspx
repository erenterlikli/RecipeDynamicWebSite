<%@ Page Title="" Language="C#" MasterPageFile="~/AnaSayfa.Master" AutoEventWireup="true" CodeBehind="AnaSayfa.aspx.cs" Inherits="YemekTarifleri.AnaSayfa1" %>
                           ...
                           <ItemTemplate>
                               <table class="auto-style6">
                                   <tr>
                                      ...
                                      <a href="YemekDetay.aspx?Yemekid=<%#Eval("YemekId")%>">    <asp:Label ID="Label7" runat="server" CssClass="auto-style7" Text='<%# Eval("YemekAd") %>' style="font-size: x-large; color: #FF3300; background-color: #FFCCFF"></asp:Label></a> 
                                           </strong></td>
                                   ...
                                   <tr>
                                       <td class="auto-style10"><strong><span class="auto-style11">Eklenme Tarihi: </span> </strong>
                                           <em>
